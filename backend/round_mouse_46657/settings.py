"""
Django settings for round_mouse_46657 project.
...
ROOT_URLCONF = 'round_mouse_46657.urls'
...
WSGI_APPLICATION = 'round_mouse_46657.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "round_mouse_46657 API",
    "DESCRIPTION": "API documentation for round_mouse_46657 App",
    "VERSION": "v1",
}
